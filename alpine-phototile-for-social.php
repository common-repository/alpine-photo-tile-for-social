<?php
/*
Plugin Name: Alpine Photo Tile for Social
Plugin URI: https://plugins.svn.wordpress.org/alpine-photo-tile-for-social/
Description: The Alpine Photo Tile for Social is capable of retrieving photos from a particular Instagram user feed. The photos can be linked to the your Instagram page, a specific URL, or to a Fancybox slideshow. Also, the Shortcode Generator makes it easy to insert the widget into posts without learning any of the code.
Version: 0.3.0
Author: the Alpine Press
Author URI: http://thealpinepress.com/
License: GNU General Public License v3.0
License URI: http://www.gnu.org/licenses/gpl-3.0.html
Text Domain: alpine-instagram
