...
class PhotoTileForInstagramPrimary {
  ...
  private $wplink = 'http://wordpress.org/extend/plugins/alpine-photo-tile-for-social';
  private $page = 'AlpineTile: Instagram';
  private $src = 'instagram';
  private $hook = 'APTFINbyTAP_hook';
  private $testmode = 0;
  private $testpoint = 0;
  private $plugins = array('pinterest');
...
//////////////////////////////////////////////////////////////////////////////////////
  ...
  function get_script($string){
    ...
    } elseif( 'magnific' == $string ){
      return $this->url.'/js/magnific/jquery.magnific-popup.min.js?ver=1.1.0';
    }
    return false;
  }
  /**
  ...
  function get_style($string){
    if( 'admin' == $string ){
      ...
      return $this->url.'/js/magnific/magnific-popup.css?ver=1.1.0';
    }
    return false;
  }
//////////////////////////////////////////////////////////////////////////////////////
  ...
  function option_defaults(){
    $options = array(
        ...
        'instagram_photo_number' => array(
            ...
            'min' => '1',
            'max' => '100',
          // 'description' => 'Maximum of 25, due to <br>Facebook <a href="http://instagram.com/about/legal/terms/api/" target="_blank">Terms of Use</a>.',
            'widget' => true,
            'tab' => 'generator',
            'position' => 'right',
            'default' => '4'
